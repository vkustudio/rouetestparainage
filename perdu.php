                ...
                <td align="center" class="animated fadeIn delay-1-6s">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <form style="margin-top: 5%" method="POST" action="php/insertUserCookiePerdu.php">
                                  ...
                                  <div class="form-group">
                                    <input type="tel" class="form-control" id="InputNrTel" name="tel" aria-describedby="nrTel" oninvalid="ShowErrMessTel()" oninput="ResetErrMessTel()" minlength="10" maxlength="10" pattern="[0]{1}[0-9]{9}" name="tel" style="border-radius: 20px" placeholder="Numéro de tél." required>
