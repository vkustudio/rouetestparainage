...
<div class="container d-flex justify-content-center" id="containerMobile">
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 d-flex justify-content-center"><img src="img/logo.png" class="imgLogoHeader animated fadeIn"></div>
...
<script>
        ...
        function percentNumber(){
          ...
          k = Math.floor(Math.random() * 10001);
          console.log(k);
          if (k <= 9990) {
        ...
        var theWheel = new Winwheel({
            ...
            [
                   {'text' : '1 DESSERT🍰'}, // 18
                   {'text' : 'PERDU...'},    // 53.5
                   {'text' : '1 CLASSIC SMASH'}, // 89
                   {'text' : 'PERDU...'},    // 124.5
                   {'text' : '1 BOISSON 33CL🥤'}, // 160
                   {'text' : 'PERDU...'},    // 195.5
                   {'text' : '3 TENDERS🍗'}, // 231
                   {'text' : 'PERDU...'},    // 266.5
                   {'text' : '3 TENDERS🍗'}, // 302
            ...
            function alertPrize(indicatedSegment){
                ...
                // Aici adaugam functia de f=verificare daca nu este a doua sansa
                        ...
                        if (indicatedSegment.text === '1 DESSERT🍰') {
                            ...
                            document.cookie = "resultRoueCVS="+resultRoue;
                            location.replace("php/perdu2Fois.php");
