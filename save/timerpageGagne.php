<?php
	...
	$datatimer = $_COOKIE['TimerGagneCVS'];
    ...
    <div class="row justify-content-center">
        <table align="center" class="table table-responsive" cellpadding="0" cellspacing="0">
            ...
            <tr class="animated zoomIn delay-08s">
                <td align="center">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12"><h1 style="text-transform: uppercase; padding: 10px; background-color: black; border-radius: 20px; color: white; font-size: 20px;">Vous avez gagné <?php echo $_COOKIE['resultCadCVS']; ?></h1></div>
                </td>
            </tr>
            <br><br>
            ...
            <tr>
                <td align="center" class="animated fadeIn delay-1-6s">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <h2 style="font-size: 19px; margin-top: 5%;"><b>Vous avez reçu un mail avec<br>
															un coupon valable à partir de demain<br>
																							pour une commande supérieure à 9€</b></h2>
                        </div>
                </td>
            </tr>
            <tr>
                <td align="center" class="animated fadeIn delay-1-6s">
                    <div class="col-xs-11 col-sm-11 col-md-11 col-lg-11" style="border-radius: 20px; border: 4px solid rgba(0, 0, 0, 0.5); width: 80%; background: rgba(0, 0, 0, 0.5);"><h1 style="padding: 3px; color: white; font-size: 17px;"><b>Pensez à vérifier vos Spams ou Indésirable</b></h1></div>
                </td>
            </tr>
            <tr>
                <td align="center" class="animated fadeIn delay-1-6s">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <h2 style="font-size: 20px; margin-top: 5%;"><b>VALABLE DANS EXACTEMENT :</b></h2>
                        </div>
                </td>
            </tr>
            <tr>
                <td align="center" class="animated fadeIn delay-1-6s">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <h2 style="font-size: 23px; margin-top: 10%; background-color: black; color: white; padding: 10px; border-radius: 20px; width: 50%;">
                            <b id="demo"></b>
                            <a href="index.php" id="refresh" style="display: none; font-size: 15px; color: white;">RECOMMENCEZ</a></h2>
                        </div>
                </td>
            </tr>
...
<?php
	...
	if ($resultTimerExpired === "EXPIRED") {

			setcookie("TimerGagneCVS", "", time() - 84600, "/", "like-up.fr");
